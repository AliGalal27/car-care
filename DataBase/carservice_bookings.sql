...
CREATE TABLE `bookings` (
  ...
  `booking_date` binary(8) NOT NULL,
  `status` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`booking_id`),
  KEY `service_schedule_id` (`service_schedule_id`),
  KEY `user_id` (`user_id`),
  KEY `bookings_ibfk_1` (`service_id`),
  CONSTRAINT `bookings_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`),
  CONSTRAINT `bookings_ibfk_2` FOREIGN KEY (`service_schedule_id`) REFERENCES `services_schedule` (`ss_id`),
